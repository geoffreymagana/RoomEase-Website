...
export default function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Stay connected with your roommates through messaging"
    }
  ];
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative min-h-screen">
        <div className="max-w-7xl mx-auto">
          <div className="text-center relative z-10">
            ...
            >
              Manage bills, chores, and roommates effortlessly. <br />
...
<div 
 className="absolute bottom-0.5 left-1/2 transform -translate-x-1/2 rotate-6"
 style={{
            ...
            <Card className="w-52 shadow-xl border-0 bg-white">
              <CardContent className="p-4">
                ...
                <div className="relative h-20">
                  <div 
                    className="absolute w-10 h-10 bg-transparent border border-gray-300 rounded flex items-center justify-center transform rotate-12"
                  ...
                  <div 
                    className="absolute w-10 h-10 bg-transparent border border-gray-300 rounded flex items-center justify-center transform -rotate-6"
                  ...
                  <div 
                    className="absolute w-10 h-10 bg-transparent border border-gray-300 rounded flex items-center justify-center transform rotate-45"
                  ...
                  <div 
                    className="absolute w-10 h-10 bg-transparent border border-gray-300 rounded flex items-center justify-center transform -rotate-20"
